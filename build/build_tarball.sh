...
rsync -av $EXCLUDE_STRING $PKG_ROOT/src/  $TMP_DIR/CloudStack
rsync -av $PKG_ROOT/LICENCE $TMP_DIR/LICENCE
rsync -av $PKG_ROOT/README.md $TMP_DIR/README.md
